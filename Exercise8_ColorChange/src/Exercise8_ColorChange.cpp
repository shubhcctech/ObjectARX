// Exercise8_ColorChange.cpp : Defines the initialization routines for the DLL.
//
...
extern "C" AcRx::AppRetCode acrxEntryPoint(AcRx::AppMsgCode msg, void* pkt)
{
	...
	case AcRx::kInitAppMsg:
		...
		acutPrintf(L"\nLoading project...\n");
		// Commands to add
		acedRegCmds->addCommand(_T("AUCommands"), _T("ColorChange"),
			_T("ColorChange"), ACRX_CMD_MODAL, changeColor);//addLine  makeLayer
		break;
