// Exercise7_UserInputLine.cpp : Defines the initialization routines for the DLL.
//
...
extern "C" AcRx::AppRetCode acrxEntryPoint(AcRx::AppMsgCode msg, void* pkt)
{
	...
	case AcRx::kInitAppMsg:
		...
		acutPrintf(L"\nLoading project...\n");
		// Commands to add
		acedRegCmds->addCommand(_T("AUCommands"), _T("UserInput"),
			_T("UserInputLine"), ACRX_CMD_MODAL, userInputLine);//addLine  makeLayer
		break;
